...
<html lang="en">
  ...
  <body>
    ...
    <script src="{{asset('dist/swagger-ui-bundle.js')}}" charset="UTF-8"> </script>
    <script src="{{asset('dist/swagger-ui-standalone-preset.js')}}" charset="UTF-8"> </script>
    <script src="{{asset('dist/swagger-initializer.js')}}" charset="UTF-8"> </script>
  </body>
</html>
